<form class="form-horizontal" action="<?php echo url($_GET['q']); ?>" method="post">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="inputNom" placeholder="Nom" name="name" value="<?php echo $user->name; ?>">
    </div>
  </div>
  <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <textarea id="inputRemarques" placeholder="Remarques" name="more" rows="10"><?php echo $user->more; ?></textarea><br />
